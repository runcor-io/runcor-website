...
export default function CompetitiveEdgeSection() {
  ...
  return (
    <section ref={sectionRef} className="section-spacing bg-section-alt">
      <div className="container-ikea">
        ...
        >
          Why <span className="text-gradient-orange">RunCor</span> wins
        </h2>

        {/* Comparison Table */}
        <div
          ref={tableRef}
          className="bg-white rounded-lg shadow-subtle overflow-hidden mb-12"
        >
          {/* Table Header */}
          <div className="grid grid-cols-3 gap-4 p-4 md:p-6 border-b border-gray-100 bg-gray-50">
            ...
            <div className="label-mono text-center text-gray-900">
              RunCor
            </div>
