...
export default function UseCasesSection() {
  ...
  return (
    <section ref={sectionRef} id="use-cases" className="section-spacing bg-section-alt">
      <div className="container-ikea">
        {/* Header */}
        <div ref={headerRef} className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
            Built for <span className="text-gradient-orange">African teams</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {industries.map((industry, index) => (
            <div
              ...
              className="card-ikea shadow-subtle hover:shadow-md transition-shadow"
            >
              {/* Icon */}
