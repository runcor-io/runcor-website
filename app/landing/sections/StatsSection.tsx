...
function StatItem({ value, label, isAnimated = false }: StatItemProps) {
  ...
  return (
    <div className="text-center">
      <p className="lp-stat-number text-4xl md:text-5xl font-bold text-gray-900 mb-2">
        {displayValue}
      </p>
      <p className="lp-label-mono">{label}</p>
    </div>
  );
}
...
export default function StatsSection() {
  ...
  return (
    <section ref={sectionRef} className="lp-section-spacing bg-white">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="lp-label-mono">Updated in real time</span>
            </div>
          </div>
        </div>
      </div>
