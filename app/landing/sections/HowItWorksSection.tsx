...
export default function HowItWorksSection() {
  ...
  return (
    <section ref={sectionRef} id="how-it-works" className="lp-section-spacing bg-white">
      <div className="lp-container">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          {/* Left Title Block */}
          <div ref={leftRef}>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
              How it <span className="lp-text-gradient-orange">works</span>
            </h2>
        ...
        <div className="mt-12 pt-8 border-t border-gray-100">
          <p className="lp-label-mono mb-4">Execution Flow</p>
          <div className="flex flex-wrap items-center gap-2 text-sm">
            <span className="px-3 py-1.5 bg-gray-100 text-gray-700 rounded">Job Posted</span>
            <span className="text-gray-400">→</span>
            <span className="px-3 py-1.5 bg-gray-100 text-gray-700 rounded">Split into chunks</span>
            <span className="text-gray-400">→</span>
            <span className="px-3 py-1.5 bg-gray-100 text-gray-700 rounded">Nodes claim</span>
            <span className="text-gray-400">→</span>
            <span className="px-3 py-1.5 bg-gray-100 text-gray-700 rounded">Docker execution</span>
            <span className="text-gray-400">→</span>
            <span className="px-3 py-1.5 lp-bg-gradient-orange text-white rounded">Results merged</span>
          </div>
        </div>
      </div>
    </section>
