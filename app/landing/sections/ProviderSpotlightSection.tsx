...
export default function ProviderSpotlightSection() {
  ...
  return (
    <section ref={sectionRef} id="providers" className="lp-section-spacing bg-white">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="relative rounded-lg overflow-hidden aspect-[4/3]">
              ...
              <div className="absolute bottom-4 left-4 right-4 bg-white rounded-lg p-4 shadow-lg">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="lp-label-mono mb-1">Earnings this month</p>
          ...
          <div ref={textRef} className="order-1 lg:order-2">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight">
              Earn on your <span className="lp-text-gradient-orange">own hardware</span>
            </h2>
